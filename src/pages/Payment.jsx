        ...
        <SafeAreaView className='flex-1 bg-white'>
            ...
            <View className='px-5'>
                ...
                <View className='mt-4 px-6'>
                    ...
                    <View className='flex-row gap-x-4 mt-4'>
                        <TouchableOpacity className='px-2 py-4 bg-white rounded-md shadow-md shadow-gray-700' onPress={() =>  (navigation.navigate('Allpayments')) }>
                          
                                <Image source={require("../assets/Visa_Logo1.png")} />
                           
                        </TouchableOpacity>

                        <TouchableOpacity className='px-3 py-3 bg-white rounded-md shadow-md shadow-gray-700' onPress={() =>  (navigation.navigate('Allpayments')) }>
                          
                                <Image source={require("../assets/MasterCard_Log1.png")} />
                          
                        </TouchableOpacity>

                        <TouchableOpacity className='px-6 py-3 bg-white rounded-md shadow-md shadow-gray-700' onPress={() => (navigation.navigate('Allpayments')) }>
            ...
            <ScrollView className='mt-3 px-10'>
                ...
                <View className='px-6 mt-8'>
                    <TouchableOpacity activeOpacity={1}   delayPressIn={0.1} onPress={() => (navigation.navigate('Login4'))} className='bg-[#003655] items-center justify-center p-1 rounded-full'>
