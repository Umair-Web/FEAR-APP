        ...
        <SafeAreaView className='bg-white flex-1'>
            ...
            <View className='px-5 mt-1 h-fit border-b-[1px] border-[#DCDCDC] '>
                <View className='flex-col justify-between items-start p-3 border-[1px] border-[#DCDCDC] rounded-xl'>
                    <Text className='font-medium text-sm text-[#4285F4]'>Credit management news</Text>
                    <Text className='font-normal text-sm '>See the latest coverage of the credit</Text>
                </View>
            ...
            <ScrollView className='mb-12'>
                <TouchableOpacity
                    activeOpacity={1} delayPressIn={1} onPress={() => (navigation.navigate("CreditNewsFull"))} className='w-full px-5  flex-row items-center justify-between'>
                    <Text className='text-[15px] font-normal text-black mt-2'>Top News</Text>
                    <TouchableOpacity activeOpacity={1} delayPressIn={1} onPress={() => (navigation.navigate("CreditNewsFull"))} className='w-5 h-5 '>
                        <Image className='w-5 h-5 mt-2' source={require("../assets/dots.png")} />
                    </TouchableOpacity>

                </TouchableOpacity>
                <TouchableOpacity  activeOpacity={1} delayPressIn={1} onPress={() => (navigation.navigate("CreditNewsFull"))} className='px-5'>
                    <Image className='w-full  h-44 mt-1 rounded-2xl' source={require("../assets/main3.png")} />
                </TouchableOpacity>

                <TouchableOpacity  activeOpacity={1} delayPressIn={1} onPress={() => (navigation.navigate("CreditNewsFull"))} className='px-5 border-b-[1px]  border-[#DCDCDC] pb-2 '>
                    ...
                    <View className='flex-row items-start gap-x-4'>
                        <View className='flex-row w-2/3 gap-x-1'>
                            ...
                            <View className='flex-col items-start'>
                                <Text className='font-medium text-[#374151] text-[14px] '>FCRA provides consumers with important rights and protections regarding their credit information, ensuring accuracy, fairness. </Text>
                ...
                <View className='flex-col items-start px-5 mt-2 border-b-[1px]  py-2   border-[#DCDCDC]'>
                    <View className='flex-row items-start gap-x-4'>
                        <View className='flex-row w-2/3 gap-x-1'>
                            ...
                            <View className='flex-col items-start'>
                                <Text className='font-medium text-[#374151] text-[14px] '>Simplify your understanding of credit with our comprehensive education hub. Learn about laws, scores, and financial management.</Text>
