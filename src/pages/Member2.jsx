      ...
      <View className="px-5">
        ...
        <View className=' mt-24 items-center px-4'>
          ...
          <View className='bg-[#00325F] w-full p-4 rounded-xl'>
            <Text className='font-semibold text-[20px] mb-2 text-white text-center'>Premium Tier</Text>
            <Text className='font-normal text-[15px] text-start text-white'>
              In addition to the features of the basic tier, the premium tier offers more comprehensive assistance from the AI assistant, access to a wider range of financial advisors, life insurance agents, CPAs, and tax attorneys. It also includes advanced tax filing capabilities and personalized recommendations based on individual financial situations. This tier price is $24.99 per month

            </Text>
            <View className='mt-4'>
              <Text className='font-extrabold text-white text-[19px]'>$25.99</Text>
