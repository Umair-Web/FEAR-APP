...
const Tax1 = () => {
    ...
    const agents = [
        { id: 1, name: "Agent 1", image: require("../assets/download.jpeg"), price: "$100", icon: "🖤", Link: "Tax2" },
        { id: 2, name: "Agent 2", image: require("../assets/download.jpeg"), price: "$150", icon: "🖤", Link: "Tax2" },
        { id: 3, name: "Agent 3", image: require("../assets/download.jpeg"), price: "$200", icon: "🖤", Link: "Tax2" },
            ...
            <View className='px-5' style={{ height: screenHeight * 0.8 }} >
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View className='items-center'>
                        ...
                        <Text className='font-semibold text-[20px] text-[#146AEB] mt-3'>TAX AGENT</Text>
